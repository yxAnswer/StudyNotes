原文：https://www.cnblogs.com/qcrao-2018/p/10903807.html
...
![hashmap bmap](https://segmentfault.com/img/remote/1460000023879181)
...
![bmap struct](https://segmentfault.com/img/remote/1460000023879182)
...
![mapacess](https://segmentfault.com/img/remote/1460000023879183)
...
![mapacess loop](https://segmentfault.com/img/remote/1460000023879184)
...
![map rehash](https://segmentfault.com/img/remote/1460000023879185)
...
![bucket split](https://segmentfault.com/img/remote/1460000023879187)
...
![扩容前](https://segmentfault.com/img/remote/1460000023879188)

扩容完成后，overflow bucket 消失了，key 都集中到了一个 bucket，更为紧凑了，提高了查找的效率。

![same size 扩容](https://segmentfault.com/img/remote/1460000023879186)

假设触发了 2 倍的扩容，那么扩容完成后，老 buckets 中的 key 分裂到了 2 个 新的 bucket。一个在 x part，一个在 y 的 part。依据是 hash 的 lowbits。新 map 中 `0-3` 称为 x part，`4-7` 称为 y part。

![2倍扩容](https://segmentfault.com/img/remote/1460000023879190)
...
![map iter loop](https://segmentfault.com/img/remote/1460000023879189)
...
![map origin](https://segmentfault.com/img/remote/1460000023879193)

这时，我们对此 map 进行遍历。假设经过初始化后，startBucket = 3，offset = 2。于是，遍历的起点将是 3 号 bucket 的 2 号 cell，下面这张图就是开始遍历时的状态：

![map init](https://segmentfault.com/img/remote/1460000023879191)
...
![iter res](https://segmentfault.com/img/remote/1460000023879192)
...
![iter res](https://segmentfault.com/img/remote/1460000023879194)
...
![iter res](https://segmentfault.com/img/remote/1460000023879195)

和之前的流程一样，继续遍历新 1 号 bucket，发现老 1 号 bucket 已经搬迁，只用遍历新 1 号 bucket 中现有的元素就可以了。结果集变成：

![iter res](https://segmentfault.com/img/remote/1460000023879197)

继续遍历新 2 号 bucket，它来自老 0 号 bucket，因此需要在老 0 号 bucket 中那些会裂变到新 2 号 bucket 中的 key，也就是 `lowbit == 10` 的那些 key。

这样，遍历结果集变成：

![iter res](https://segmentfault.com/img/remote/1460000023879196)
...
【sync.map 源码分析】https://github.com/Chasiny/Blog/blob/master/blog/go/sync.Map源码分析.md
...
【煎鱼大佬博客 map1】https://github.com/EDDYCJY/blog/blob/master/golang/pkg/2019-03-04-深入理解Go-map-初始化和访问元素.md

【煎鱼大佬博客 map2】https://github.com/EDDYCJY/blog/blob/master/golang/pkg/2019-03-24-深入理解Go-map-赋值和扩容迁移.md

【哈希函数的定义】http://zhangshuai.ren/2018/05/16/散列算法实现Go语言Map函数/

【如何比较两个 map 相等】https://golangbot.com/maps/

【NAN hash】https://research.swtch.com/randhash

【并发安全阐述】http://zjykzk.github.io/post/cs/golang/map/